...
<div class="container">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb">
                  <!--  <li><fmt:message key="MEMBER"/></li>-->
                    <!-- <li class="active">EXIT_MEMBER</li>-->
                </ol>
            </div>
        </div>
    </div>
	...
	<div class="form-group">
      ...
      <div class="col-sm-4">
      <input type="password" name="password" id="password" class="form-control"><h4 style="color:red;"></h4>
      </div>
    </div>
    <div class="form-group">
    	<div class="col-sm-offset-2 col-sm-8">
		<input type="submit" class="btn btn-info" value="DELETE_USER_INFO">
		</div>
	</div>
	</form>
	</div>
